...
*/
intMin = parseFloat(prompt("Please enter the minimum number for your guessing range \n(must be at least 0)"));
while(isNaN(intMin)==true || intMin<0) //Checks to see if input is a number and is at least 0
{
